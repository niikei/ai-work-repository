...
2. Choose the lightest valid representation:
   ...
   - Typed artifact for a durable report, analysis, specification, or deliverable.
...
7. Keep event history in Logs and current state in Project or Area documents.
8. Do not edit generated related-link blocks or `DASHBOARD.md` directly.
